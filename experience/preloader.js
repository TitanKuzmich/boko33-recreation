    ...
    secondIntro() {
        return new Promise((resolve) => {
            ...
            this.secondTimeline
                ...
                .to(
                    this.roomChildren["floor-items"].scale,
                    {
                        x: 1,
                        y: 1,
                        z: 1,
                ...
                .to(
                    this.roomChildren["table-items"].scale,
                    {
                        x: 1,
                        y: 1,
                        z: 1,
                ...
                .set(this.roomChildren.ground.scale, {
                    x: 1,
                    y: 1,
                    z: 1,
                })
                ...
                .to(
                    this.roomChildren.conditioner.scale,
                    {
                        x: 1,
                        y: 1,
                        z: 1,
